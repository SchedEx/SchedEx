defmodule SchedExTest do
  ...
  defmodule TestTimeScale do
    ...
    def handle_call(
      ...
      diff = round(DateTime.diff(DateTime.utc_now(), time_0, :millisecond) * speedup)
  ...
  describe "run_at" do
    test "runs the m,f,a at the expected time", context do
      SchedEx.run_at(
        ...
        :append,
        [context.agent, 1],
        DateTime.add(DateTime.utc_now(), @sleep_duration, :millisecond)
      )
    ...
    test "runs immediately (but not in process) if the expected time is in the past", context do
      SchedEx.run_at(
        ...
        :append,
        [context.agent, 1],
        DateTime.add(DateTime.utc_now(), -100 * 3600, :second)
      )
  ...
  describe "run_in" do
    ...
    test "optionally passes the runtime into the m,f,a", context do
      ...
      expected_time = DateTime.add(now, @sleep_duration, :millisecond)
